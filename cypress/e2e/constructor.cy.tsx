describe('Тесты е2е для главной страницы и модального окна', function () {
  ...
  it('Закрытие модального окна ингредиента по иконке', function () {
    cy.get(ingredientSelector).first().as('firstIngredient');
    cy.get('@firstIngredient').click();
  ...
  it('Добавление ингредиентов и успешное оформление заказа', function () {
